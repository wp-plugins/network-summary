		...
		<table class="form-table">
			...
			<tr>
				<th class="label-row-deciding-role"><label
						for="<?php echo NETWORK_SUMMARY_OPTIONS ?>[deciding_role]"><?php _e( 'Deciding
						Role on Sharing Content', 'network-summary' ); ?></label></th>
				<td>

					<select name="<?php echo NETWORK_SUMMARY_OPTIONS ?>[deciding_role]" required>
